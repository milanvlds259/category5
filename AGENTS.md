...
- Active scene:
  - Name: SampleScene
  - Tags:
    - Untagged, Respawn, Finish, EditorOnly, MainCamera, Player, GameController, Path, MapCamera
  - Layers:
    - Default, TransparentFX, Ignore Raycast, Player, Water, UI, Enemy, Projectile, CloudSurface, PlayerInTunnel, Map
- Active game object:
  - Name: Arena_0
  - Tag: Untagged
  - Layer: Default
